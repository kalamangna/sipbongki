...
class UpdateKartuKeluargaRequest extends FormRequest
{
    ...
    {
        $kkId = $this->route('kartu_keluarga') instanceof \App\Models\KartuKeluarga 
            ? $this->route('kartu_keluarga')->id 
            : $this->route('kartu_keluarga');
        ...
        return [
            'no_kk' => [
                ...
                'numeric',
                'digits:16',
                Rule::unique('kartu_keluargas', 'no_kk')->ignore($kkId),
            ],
            'kepala_keluarga_id' => [
                'nullable',
                'exists:penduduks,id',
