...
class UpdateJabatanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nama' => [
                ...
                'string',
                'max:100',
                Rule::unique('jabatans', 'nama')->ignore($this->jabatan),
            ],
            ...
            'parent_id' => [
                ...
                // Mencegah jabatan menjadi parent dirinya sendiri
                Rule::notIn([$this->jabatan->id]),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'parent_id.not_in' => 'Jabatan tidak boleh menjadi parent dirinya sendiri.',
