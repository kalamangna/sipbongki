...
<section class="py-24 bg-slate-50 dark:bg-slate-950 pt-32">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-8" aria-label="Breadcrumb">
            ...
            <a href="{{ route('home') }}#berita" class="hover:text-primary dark:hover:text-primary-400 transition-colors focus:outline-none focus:ring-2 focus:ring-primary rounded">Berita</a>
            <i class="fa-solid fa-chevron-right text-[10px]"></i>
            <span class="text-slate-400 dark:text-slate-500" aria-current="page">Detail Berita</span>
        </nav>
            ...
            <div class="lg:col-span-8">
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-800 pb-6 mb-8">
                    <div class="flex items-center gap-2 bg-white dark:bg-slate-900 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-800 shadow-sm">
                        ...
                        <span class="font-medium text-slate-700 dark:text-slate-300">{{ optional($berita->tanggal_publish)->translatedFormat('d F Y') ?? $berita->created_at->translatedFormat('d F Y') }}</span>
                    </div>
                    <div class="flex items-center gap-2 bg-white dark:bg-slate-900 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-800 shadow-sm">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden mb-8">
                    ...
                    <div class="p-6 md:p-10 prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-a:text-primary dark:prose-a:text-primary-400 prose-img:rounded-2xl leading-relaxed [&_br]:block [&_br]:mt-3">
                    ...
                    <div class="px-6 md:px-10 py-5 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <span class="text-sm font-bold text-slate-700 dark:text-slate-200">Bagikan artikel ini:</span>
            ...
            <aside class="lg:col-span-4 space-y-8 sticky top-28">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                    <h3 class="text-base font-bold text-slate-800 dark:text-slate-100 mb-4 flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                        <i class="fa-solid fa-newspaper text-primary dark:text-primary-400"></i> Berita Terbaru
                    </h3>
                    ...
                    <div class="flex flex-col gap-4">
                        @forelse($beritaTerbaru ?? [] as $terbaru)
                            <a href="{{ route('berita.show', $terbaru->slug) }}" class="group flex gap-4 items-start focus:outline-none focus:ring-2 focus:ring-primary rounded-xl">
                                <div class="w-20 h-20 shrink-0 rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800 shadow-inner">
                        ...
                        @empty
                            <p class="text-sm text-slate-500 dark:text-slate-400 italic">Belum ada berita lainnya.</p>
                        @endforelse
                    </div>
                </div>
