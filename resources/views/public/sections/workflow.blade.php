...
═══════════════════════════════════════════════ --}}
<section id="alur-pelayanan" class="py-24 bg-slate-50 dark:bg-slate-900/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-14 max-w-2xl mx-auto">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4">Tahapan Permohonan</h2>
        </div>
        ...
        <div class="relative">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center">
                    ...
                    <h3 class="text-base font-bold text-slate-800 dark:text-slate-100 mb-1.5">Ajukan Permohonan</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Pilih jenis layanan dan lengkapi data permohonan surat secara online.</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center">
                    ...
                    <h3 class="text-base font-bold text-slate-800 dark:text-slate-100 mb-1.5">Verifikasi Berkas</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Petugas kelurahan memeriksa keabsahan dan kelengkapan berkas pemohon.</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center">
                    ...
                    <h3 class="text-base font-bold text-slate-800 dark:text-slate-100 mb-1.5">Proses Surat</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Penerbitan format resmi dan penandatanganan oleh pejabat yang berwenang.</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center">
                    ...
                    <h3 class="text-base font-bold text-slate-800 dark:text-slate-100 mb-1.5">Surat Selesai</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Dokumen surat selesai diproses dan siap diambil atau diunduh langsung.</p>
                </div>
