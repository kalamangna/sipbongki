...
<div class="w-full">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Edit Jabatan</h2>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Perbarui data jabatan.</p>
        </div>
