...
<div class="w-full">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Buat Permohonan</h2>
            <p class="text-sm text-slate-500 mt-1">Ajukan permohonan surat baru untuk warga.</p>
        </div>
    ...
    <form action="{{ route('admin.permohonan-surat.store') }}" method="POST" class="space-y-6" id="formPermohonan">
        @csrf
