            ...
            <div class="flex flex-column gap-3 items-center">
                ...
                <div class="w-100" style="max-width:220px;">
                    <form
                        ...
                        <button
                            class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold rounded-xl transition-all btn-outline-danger !px-3 !py-1.5 !text-xs w-100"
            ...
            <div class="flex flex-column gap-3 items-center">
                ...
                <div class="w-100" style="max-width:220px;">
                    <a
                        ...
                        target="_blank"
                        class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold rounded-xl transition-all btn-secondary !px-3 !py-1.5 !text-xs w-100">
