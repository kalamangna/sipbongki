        ...
        placeholder="Alamat sebelum berdomisili">{{ old('alamat_asal', $permohonanSurat->data_surat['alamat_asal'] ?? '') }}</textarea>
            ...
            <div class="w-full px-3 mb-4">
                ...
                <textarea
                    name="alamat"
                    rows="3"
                    class="form-control">{{ old('alamat', $permohonanSurat->data_surat['alamat'] ?? '') }}</textarea>
            </div>
...
<div class="flex justify-end">
    ...
    <a
        ...
        class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold rounded-xl transition-all btn-secondary mr-2">
