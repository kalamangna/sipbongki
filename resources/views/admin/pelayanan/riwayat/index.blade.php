            ...
            <table class="w-full text-sm text-left text-slate-600 min-w-[750px]">
                <thead class="text-xs font-semibold text-slate-500 uppercase bg-slate-50/80">
                    <tr>
                        ...
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100">No. Permohonan</th>
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100">Pemohon</th>
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100">Jenis Surat</th>
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100 text-center">Status</th>
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100 text-center">Tanggal Selesai</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="px-4 sm:px-6 py-3.5 sm:py-4 font-mono font-medium text-slate-900 text-xs">{{ $item->nomor_permohonan }}</td>
                        ...
                        <td class="px-4 sm:px-6 py-3.5 sm:py-4 text-slate-700">
                        ...
                        <td class="px-4 sm:px-6 py-3.5 sm:py-4 text-center text-slate-500">
