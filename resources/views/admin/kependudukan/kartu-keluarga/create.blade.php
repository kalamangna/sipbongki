...
<div class="w-full">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-slate-900 tracking-tight dark:text-slate-100">Tambah Kartu Keluarga</h2>
            <p class="text-sm text-slate-500 mt-1 dark:text-slate-400">Buat data Kartu Keluarga (KK) baru di dalam sistem.</p>
        </div>
