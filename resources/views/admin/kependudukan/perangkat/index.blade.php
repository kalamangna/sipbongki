...
<div class="w-full">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Aparatur</h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-slate-600 min-w-[650px]">
                <thead class="text-xs font-semibold text-slate-500 uppercase bg-slate-50/50">
                    <tr>
                        <th width="80" class="px-4 sm:px-6 py-4 border-b border-slate-100 text-center">Foto</th>
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100">Nama Lengkap</th>
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100">NIP</th>
                        <th class="px-4 sm:px-6 py-4 border-b border-slate-100">Jabatan</th>
                        <th width="100" class="px-4 sm:px-6 py-4 border-b border-slate-100 text-center">Status</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="px-4 sm:px-6 py-3.5 sm:py-4 font-bold text-slate-900">{{ $perangkat->nama_lengkap }}</td>
                        <td class="px-4 sm:px-6 py-3.5 sm:py-4 font-mono text-slate-700">{{ $perangkat->nip ?? '-' }}</td>
                        <td class="px-4 sm:px-6 py-3.5 sm:py-4 font-medium text-slate-800">{{ $perangkat->jabatan->nama ?? '-' }}</td>
                        <td class="px-4 sm:px-6 py-3.5 sm:py-4 text-center">
                            @if($perangkat->aktif)
