...
<div class="w-full">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Tambah Perangkat</h2>
            <p class="text-sm text-slate-500 mt-1">Tambahkan data aparatur dan perangkat kelurahan baru.</p>
        </div>
    ...
    <form action="{{ route('admin.perangkat.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
