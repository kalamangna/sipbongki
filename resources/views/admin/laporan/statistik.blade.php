...
<div class="w-full">
 ...
 <div class="w-full px-3 w-full lg:w-1/2 px-3 w-full xl:w-1/3 px-3">
 ...
 <div class="w-full px-3 w-full xl:w-1/3 px-3">
 <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm h-100">
 ...
 <div class="w-full px-3 md:w-1/2 w-full xl:w-1/3 px-3">
 <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm h-100">
 ...
 <div class="w-full px-3 w-full md:w-full px-3 w-full xl:w-1/3 px-3">
 <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm h-100">
