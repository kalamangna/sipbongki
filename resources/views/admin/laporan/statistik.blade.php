...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    <div>
        <h3 class="text-2xl font-bold text-slate-800 mb-1">Laporan Statistik Kelurahan</h3>
        <p class="text-sm text-slate-500">Visualisasi data demografi dan statistik kependudukan Kelurahan Bongki</p>
    </div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-6">
    <div class="bg-white rounded-2xl p-5 ring-1 ring-slate-200/60 shadow-sm text-center">
        ...
        <p class="text-3xl font-extrabold text-slate-900">{{ number_format($totalPenduduk ?? 0) }}</p>
    </div>
    <div class="bg-white rounded-2xl p-5 ring-1 ring-slate-200/60 shadow-sm text-center">
        <p class="text-xs font-semibold text-slate-500 uppercase tracking-widest mb-1">Laki-laki</p>
        <p class="text-3xl font-extrabold text-sky-600">{{ number_format($totalLaki ?? 0) }}</p>
    </div>
    <div class="bg-white rounded-2xl p-5 ring-1 ring-slate-200/60 shadow-sm text-center">
        <p class="text-xs font-semibold text-slate-500 uppercase tracking-widest mb-1">Perempuan</p>
        <p class="text-3xl font-extrabold text-rose-500">{{ number_format($totalPerempuan ?? 0) }}</p>
    </div>
    <div class="bg-white rounded-2xl p-5 ring-1 ring-slate-200/60 shadow-sm text-center">
        <p class="text-xs font-semibold text-slate-500 uppercase tracking-widest mb-1">Kartu Keluarga</p>
        <p class="text-3xl font-extrabold text-emerald-600">{{ number_format($totalKK ?? 0) }}</p>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
    {{-- Jenis Pekerjaan --}}
    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
