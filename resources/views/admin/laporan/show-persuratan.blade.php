...
<div class="container-fluid">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.laporan.persuratan') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold rounded-xl transition-all btn-secondary">
