...
@php
    $judul = 'SURAT KETERANGAN BELUM MEMILIKI RUMAH';
@endphp
...
<p style="margin-left:2px; text-align:justify;">
    ...
    <strong>{{ $permohonan->pemohon->lingkungan?->nama ?? '-' }}</strong>,
    Kelurahan Bongki, Kecamatan Sinjai Utara, Kabupaten Sinjai dan berdasarkan data yang ada
    bahwa yang bersangkutan sampai saat ini benar <strong>belum memiliki rumah tinggal sendiri</strong>.
</p>
