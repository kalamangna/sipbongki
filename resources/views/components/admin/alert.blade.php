@if(session('success'))
    <div
        id="globalAlert"
        class="alert alert-success alert-dismissible fade show border-0 shadow-sm mb-4 auto-dismiss"
        role="alert">
...
@if(session('info'))
    <div
        id="globalAlert"
        class="alert alert-info alert-dismissible fade show border-0 shadow-sm mb-4 auto-dismiss"
        role="alert">
