...
Route::prefix('operator')
    ...
    */
    ...
    Route::get(
        'pengaduan',
        [OperatorPengaduanController::class, 'index']
    )
    ->name('pengaduan.index');

    Route::get(
        'pengaduan/{pengaduan}',
        [OperatorPengaduanController::class, 'show']
    )
    ->name('pengaduan.show');

    Route::patch(
        'pengaduan/{pengaduan}',
        [OperatorPengaduanController::class, 'update']
    )
    ->name('pengaduan.update');

    Route::delete(
        'pengaduan/{pengaduan}',
        [OperatorPengaduanController::class, 'destroy']
    )
...
Route::prefix('laporan')
    ...
    ->group(function () {
        ...
        Route::get(
            ...
            [OperatorLaporanController::class, 'showKartuKeluarga']
        ...
        Route::get(
            '/persuratan/{permohonanSurat}',
            [OperatorLaporanController::class, 'showPersuratan']
        )->name('persuratan.show');
